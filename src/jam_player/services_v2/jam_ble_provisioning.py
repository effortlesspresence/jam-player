...
class NoInputNoOutputAgent(dbus.service.Object):
    ...
    def RequestPasskey(self, device):
        """
        Return a passkey for pairing (returns 0 for NoInputNoOutput).
        """
    ...
    def RequestConfirmation(self, device, passkey):
        """
        Confirm a passkey match - auto-confirms to prevent popups.
        """
    ...
    def RequestPinCode(self, device):
        """
        Return a PIN code for pairing (returns "0000" for NoInputNoOutput).
        """
...
def _trigger_post_announce_services():
    ...
    services_to_restart = [
        ...
        'jam-registration-poller.timer',   # Poll for registration status
    ]
